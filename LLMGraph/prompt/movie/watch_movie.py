...
@movie_prompt_registry.register("select_movies")
class SelectMoviesPromptTemplate(BaseChatPromptTemplate):
    def __init__(self, **kwargs):
        template = kwargs.pop("template", movie_prompt_default.get("select_movies", ""))
        input_variables = kwargs.pop("input_variables", [
            "role_description", "searched_info", "memory", "agent_scratchpad"
        ])
