...
from Emulate.tool import create_forum_retriever_tool
from Emulate.utils.graph import build_social_graph
...
from Emulate.loader.social import SocialLoader
...
class SocialManager(BaseManager):
    ...
    def load_data(cls,
        ...
        #embeddings = HuggingFaceEmbeddings(model_name ="thenlper/gte-small",cache_folder="Emulate/utils/model")
