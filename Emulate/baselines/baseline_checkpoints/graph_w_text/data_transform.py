...
BASE_G_PATH = "/home/users/wangzh/cenjch3/GraphAgent_writing/Emulate/baselines/baseline_checkpoints/graph_w_text"
# BiGG.L  bigg_gen
# GRAN.L  gran_gen
# BwR.L  bwr_graphrnn
...
# 节点文本属性路径
# BASE_TEXT_PATH = "/home/users/wangzh/cenjch3/GraphAgent_writing/Emulate/baselines/baseline_checkpoints/node_text"
...
def transform_graph_to_pipeline_input():
    ...
    # 为了匹配你的 `Emulate_dataloader.py` 逻辑，我们需要构建一个 "引用了谁" 的列表。
