...
from citation_llm_graphs import readinfo, build_citation_graph

from analysis.mmd import evaluate_sampled_graphs
...
def eval_citation_graphs(data_name):
    ...
    model_dir_map = {
        "bwr_graphrnn": "Emulate/baselines/baseline_checkpoints/bwr_graphrnn",
        "ppgn":"Emulate/baselines/baseline_checkpoints/l_ppgn",
        "bigg":"Emulate/baselines/baseline_checkpoints/bigg_gen",    
        "gran":"Emulate/baselines/baseline_checkpoints/gran_gen",
        "graphmaker_sync":"Emulate/baselines/baseline_checkpoints/graphmaker_sync",
        "SwinGNN":"Emulate/baselines/baseline_checkpoints/SwinGNN",
        "GDSS":"Emulate/baselines/baseline_checkpoints/GDSS",
    }
