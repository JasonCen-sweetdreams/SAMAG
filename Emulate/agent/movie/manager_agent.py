...
from Emulate.manager import MovieManager
...
Content: {page_content}""")
    ...
    def update(self,
        ...
        #                                            **retriever_kargs_update)
        get_reviews_tool_func, get_reviews_tool_dict = self.movie_manager.get_reviews_tool()
        tools = {   "SearchMovie":ToolAgent( 
                        "SearchMovie",
                        tool_func=retriever_tool_func,
                        func_desc=retriever_tool_dict
                        ),
                    "GetReviewsForMovie": ToolAgent(
                        "GetReviewsForMovie",
                        tool_func=get_reviews_tool_func,
                        func_desc=get_reviews_tool_dict
                        )
