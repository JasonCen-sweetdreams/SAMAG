...
from Emulate.prompt.movie import movie_prompt_registry

from Emulate.output_parser import movie_output_parser_registry
...
from Emulate.memory import movie_memory_registry, MovieMemory
